      ...
      absolute bottom-0 left-0 right-0 bg-[#10131f] m-2 p-4 rounded-md">
        ...
        <div className="mt-5 flex justify-between items-center gap-2">
          <div className="flex items-center gap-2">
            <div className='text-white w-7 h-7 rounded-full
            object-cover bg-green-700 flex justify-center items-center
            text-xs font-bold'>{name[0]}</div>
          ...
          onClick={() => downloadImage(_id, photo)}>
            ...
            className='w-6 oject-contain invert cursor-pointer'/>
          </button>
        </div>
      </div>
    </div>
